        ...
        <div className="column is-three-quarters">
          <div className="columns">
            ...
            <div className="column">FNE 25-90, association loi 1901 adhérente au {' '}
              <Link to="/fne-25-90/le-mouvement-fne/">réseau national</Link> de France Nature Environnement, est{' '}
              <strong>
          ...
          <div className="columns" id="fne2590">
            <section className="column has-text-centered">
              ...
              <div>7 rue Voirin – 25000 Besançon</div>
              <div>Tél : 03 81 61 36 44</div>
            </section>
            <section className="column has-text-centered">
              <h2>Antenne FNE de Belfort</h2>
              <div>132 avenue Jean-Jaurès – 90 000 Belfort</div>
